...
void move()
{
float i,temp=0.3,templ=0.3;

for(i=0;i<170;i=i+temp) //movement of data packet from 1to 3
{ 
glColor3f(1,0,0);
glBegin(GL_QUADS);
...
glColor3f(1.0,1.0,1.0);
drawstring(160.5,110.5,1.0,"Shortest path from Node 1to destination node 6");
glColor3f(1.0,1.0,1.0);
...
drawstring(160.5,110.5,1.0,"Shortest path from Node 1to destination node 6"); 
glColor3f(0.0,0.0,0.0);
drawstring(160.5,98.5,1.0,"1-> 3 -> 611"); 
glColor3f(0.0,0.0,0.0); 
drawstring(160.5,86.5,1.0,"Cost C16= 3 (2+1) ");
glFlush();//2 delaypacket();
...
glColor3f(1.0,0,0);
drawstring(160.5,110.5, 0,"Shortest path from Node 3 to destination node 6"); 
glColor3f(1.0,1.0,1.0);
...
glFlush();/////8 
delaypacket();
for(i=0;i<83;i=i+temp)//move ment of data packet 5 to 6
{ 
glColor3f(1,0,0);
glBegin(GL_QUADS); 
...
drawstring(160.5,110.5,1.0,"Shortest path from Node 5 to destination node 6"); 
glColor3f(0.0,0.0,0.0);
drawstring(160.5,98.5,1.0,"5 -> 611");
glColor3f(0.0,0.0,0.0);
drawstring(160.5,86.5, 1.0,"Cost C56= 2  "); 
glFlush(); //118
}
...
if ((x>=185 && x<=310) && (y>=370 && y<=390 ))// 1menu
{
draw1();
node1(); 
keyboardinteraction();
